    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Enter NAMASTE code (e.g., EM-1)"
        ...
        <div className="card p-6">
          ...
          {validationResult ? (
            <div className={`p-4 rounded-lg ${validationResult.isValid ? 'bg-success-50 border border-success-200' : 'bg-danger-50 border border-danger-200'
              }`}>
        ...
        <div className="card p-6">
          ...
          <div className="space-y-4 text-sm">
            <div>
              ...
              <p className="text-slate-600">{validationResult.ICD_11_code} - {validationResult.icdDescription}</p>
            </div>
            <div>
